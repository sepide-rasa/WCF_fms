...
namespace WCF_FMS.DAL.Daramad
{
    public class DL_CodhayeDaramd
    {
        ...
        public OBJ_CodhayeDaramd Detail(int Id)
        {
            ...
            {
                var k = p.spr_tblCodhayeDaramdSelect("fldId", Id.ToString(),0, 1)
        ...
        #endregion
        #region Select
        public List<OBJ_CodhayeDaramd> Select(string FieldName, string FilterValue,int OrganId, int h)
        {
            using (RasaNewFMSEntities p = new RasaNewFMSEntities())
            {
                var k = p.spr_tblCodhayeDaramdSelect(FieldName, FilterValue,OrganId, h)
                    .Select(q => new OBJ_CodhayeDaramd()
                    {
                        fldDate = q.fldDate,
                        fldDesc = q.fldDesc,
        ...
        #endregion
        #region Insert
        public string Insert(int Id,string DaramadCode, string DaramadTitle, bool MashmooleArzesheAfzoode, bool MashmooleKarmozd,int? UnitId, int UserId, string Desc)
        {
            using (RasaNewFMSEntities p = new RasaNewFMSEntities())
            {
                p.spr_tblCodhayeDaramdInsert(Id,DaramadCode, DaramadTitle, MashmooleArzesheAfzoode, MashmooleKarmozd,UnitId, UserId, Desc);
        ...
        #endregion
        #region Update
        public string Update(int Id, string DaramadCode, string DaramadTitle, bool MashmooleArzesheAfzoode, bool MashmooleKarmozd, int? UnitId, int UserId, string Desc)
        {
            using (RasaNewFMSEntities p = new RasaNewFMSEntities())
            {
                p.spr_tblCodhayeDaramdUpdate(Id, DaramadCode, DaramadTitle, MashmooleArzesheAfzoode, MashmooleKarmozd, UnitId, UserId, Desc);
        ...
        public bool CheckRepeatedRow(string DaramadCode, string DaramadTitle, int Id)
        {
            ...
            using (RasaNewFMSEntities p = new RasaNewFMSEntities())
            {
                if (Id == 0)
                {
                    var m = p.spr_tblCodhayeDaramdSelect("fldDaramadCode", DaramadCode,0, 0).FirstOrDefault();
                    if (m != null)
                    {
                        q = true;
                        return q;
                    }
                    var m1 = p.spr_tblCodhayeDaramdSelect("fldDaramadTitle", DaramadTitle,0, 0).FirstOrDefault();
                    if (m1 != null)
                    {
                        q = true;
                        return q;
                ...
                {
                    var query = p.spr_tblCodhayeDaramdSelect("fldDaramadCode", DaramadCode,0, 0).FirstOrDefault();
                    if (query != null && query.fldId != Id)
                    {
                        q = true; return q;
                    }
                    var query1 = p.spr_tblCodhayeDaramdSelect("fldDaramadTitle", DaramadTitle,0, 0).FirstOrDefault();
        ...
        public bool CheckDelete(int Id)
        {
            ...
            {
                var q = false;
                var Sh = m.spr_tblShomareHesabCodeDaramadSelect("fldCodeDaramadId", Id.ToString(), "", 0).FirstOrDefault();
                if (Sh != null )
                    q = true;
                return q;
            }
