...
{
    public class OBJ_PayPersonalInfo
    {
        ...
        public Nullable<int> fldStatusId { get; set; }
        public string fldStatusTitle { get; set; }
        public string fldHamsarKarmandName { get; set; }
        ...
        public string fldNoeEstekhdamTitle { get; set; }
